...
export default function AvailabilityCard({ bus }: Props) {
  ...
  const handleConfirm = () => {
    ...
    // or POST bookingData to /api/bookings
  };
          ...
          >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="h-12 w-full rounded-xl border border-gray-200 bg-white px-4 text-sm outline-none transition placeholder:text-gray-400 focus:border-teal-700 focus:ring-2 focus:ring-teal-100"
                      />
                    </div>
            ...
            <div className="flex shrink-0 flex-col-reverse gap-3 border-t border-gray-100 bg-white px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-7">
              ...
              <p className="text-center text-xs text-gray-400 sm:text-left">
                Your information will be securely sent to the admin.
              </p>
              ...
              <div className="flex w-full gap-3 sm:w-auto">
                ...
                <button
                  type="button"
                  onClick={() => setShowBookingModal(false)}
                  className="flex-1 rounded-xl border border-gray-200 px-5 py-3 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 sm:flex-none"
                >
                  Cancel
                </button>
