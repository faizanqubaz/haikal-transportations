...
export default function AllBookingsPage() {
  ...
  async function confirmDelete() {
    ...
    try {
      const res = await fetch(
        `/api/bookings/${deletingBooking._id}`,
        {
          method: "DELETE",
        }
      );
                    ...
                    >
                      ...
                      <div className="mt-4 flex gap-2">
                        ...
                        <button
                          ...
                          className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-gray-200 py-2.5 text-xs font-bold text-gray-600 transition hover:bg-teal-50 hover:text-teal-700"
                        >
                          <Pencil
                            size={13}
                          />
                        ...
                        <button
                          ...
                          className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-red-100 py-2.5 text-xs font-bold text-red-500 transition hover:bg-red-50"
                        >
                          <Trash2
                            size={13}
                          />
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-gray-100 px-6 py-5">
                ...
                <button
                  onClick={closeEdit}
                  disabled={saving}
                  className="flex h-9 w-9 items-center justify-center rounded-xl text-gray-400 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <X size={18} />
                </button>
              ...
              <div className="space-y-4 p-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <Field label="Passenger name">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm outline-none transition focus:border-teal-600 focus:ring-2 focus:ring-teal-600/10 disabled:bg-gray-50"
                    />
                ...
                <Field label="Gender">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full appearance-none rounded-xl border border-gray-200 bg-white py-2.5 pl-10 pr-3 text-sm outline-none transition focus:border-teal-600 focus:ring-2 focus:ring-teal-600/10 disabled:bg-gray-50"
                    >
                ...
                <Field label="Status">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm outline-none transition focus:border-teal-600 focus:ring-2 focus:ring-teal-600/10 disabled:bg-gray-50"
                  >
                ...
                {saveError && (
                  <div className="rounded-xl border border-red-100 bg-red-50 px-3 py-3 text-xs font-semibold text-red-600">
                    {saveError}
                  </div>
                )}
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    onClick={closeEdit}
                    disabled={saving}
                    className="flex-1 rounded-xl border border-gray-200 py-3 text-sm font-bold text-gray-600 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Cancel
                  </button>
